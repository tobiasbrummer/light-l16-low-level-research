...
OUTPUT_DIR="$PROJECT_ROOT/.build/meter-focus-probe"
APK="$OUTPUT_DIR/light-l16-meter-focus-probe-debug.apk"
...
TEMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/light-l16-meter-focus.XXXXXX")
...
javac -source 8 -target 8 \
    ...
    -d "$TEMP_DIR/classes" \
    "$SCRIPT_DIR/src/io/github/tobiasbrummer/lightl16/meterfocusprobe/MainActivity.java"

...
OUTPUT_DIR="$PROJECT_ROOT/.build/stock-lri-capture"
APK="$OUTPUT_DIR/light-l16-stock-lri-capture-debug.apk"
...
TEMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/light-l16-stock-lri.XXXXXX")
...
javac -source 8 -target 8 \
    ...
    -d "$TEMP_DIR/classes" \
    "$SCRIPT_DIR/src/io/github/tobiasbrummer/lightl16/stocklricapture/MainActivity.java"

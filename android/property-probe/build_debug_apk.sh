...
OUTPUT_DIR="$PROJECT_ROOT/.build/property-probe"
APK="$OUTPUT_DIR/light-l16-property-probe-debug.apk"
...
TEMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/light-l16-property-probe.XXXXXX")
...
javac -source 8 -target 8 \
    ...
    -d "$TEMP_DIR/classes" \
    "$SCRIPT_DIR/src/io/github/tobiasbrummer/lightl16/propertyprobe/MainActivity.java"

"$D8" --min-api 21 --lib "$ANDROID_JAR" \
    --output "$TEMP_DIR/dex" \
    "$TEMP_DIR/classes/io/github/tobiasbrummer/lightl16/propertyprobe/MainActivity.class" \
    "$TEMP_DIR/classes/io/github/tobiasbrummer/lightl16/propertyprobe/MainActivity\$1.class" \
    "$TEMP_DIR/classes/io/github/tobiasbrummer/lightl16/propertyprobe/MainActivity\$2.class"

...
OUTPUT_DIR="$PROJECT_ROOT/.build/a1-capture"
APK="$OUTPUT_DIR/light-l16-a1-inline-focus-capture-debug.apk"
SUPERVISOR="$PROJECT_ROOT/device/a1_hostless_capture_supervisor.sh"
CHILD="$PROJECT_ROOT/device/a1_capture_once.sh"
AF_SHIM_BUILDER="$PROJECT_ROOT/host/build_lcc_a1_focus_capture_shim.sh"
EXPECTED_SUPERVISOR_SIZE=13897
EXPECTED_SUPERVISOR_SHA256=ce744c4f8518ad0ae494e5378d44f2cef4b1d675c3e01ec28944dc3111dceb67
EXPECTED_CHILD_SIZE=50264
EXPECTED_CHILD_SHA256=6e33e4d5185c0433af19482bc08221de8166568e0ffcfd347299896a43c5d128
...
TEMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/light-l16-a1-capture.XXXXXX")
trap 'rm -rf "$TEMP_DIR"' EXIT HUP INT TERM
mkdir -p "$TEMP_DIR/classes" "$TEMP_DIR/dex" "$TEMP_DIR/assets" "$OUTPUT_DIR"
cp "$SUPERVISOR" "$TEMP_DIR/assets/a1_hostless_capture_supervisor.sh"
...
javac -source 8 -target 8 \
    ...
    -d "$TEMP_DIR/classes" \
    "$SCRIPT_DIR/src/io/github/tobiasbrummer/lightl16/a1capture/MainActivity.java"

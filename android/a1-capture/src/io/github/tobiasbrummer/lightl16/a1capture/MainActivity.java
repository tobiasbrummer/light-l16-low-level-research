package io.github.tobiasbrummer.lightl16.a1capture;
...
public final class MainActivity extends Activity {
    ...
    private static final String PRIVATE_DIR =
        "/data/data/io.github.tobiasbrummer.lightl16.a1capture/files";
    private static final String USER_ZERO_PRIVATE_DIR =
        "/data/user/0/io.github.tobiasbrummer.lightl16.a1capture/files";
    ...
    private static final String EXPECTED_SUPERVISOR_SHA256 =
        "fc540eebe4f1fe4f9c8d237f4077aa857fc9f6828a4c0582a768c3fa364d6282";
    private static final long EXPECTED_CHILD_SIZE = 44185L;
    private static final String EXPECTED_CHILD_SHA256 =
        "3523dd36d94532e124abb995717a98c4bf7f1c1fcdc220fbf3bfa4b70693b9a5";
    ...
    private static final String ARM_VALUE =
        "L16_HOSTLESS_A1_INLINE_AF_CAPTURE_SUPERVISOR_ONCE_V1";
    private static final String SPENT_VALUE =
        "L16_HOSTLESS_A1_INLINE_AF_CAPTURE_SPENT_V1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        explanation.setText(
            "Feste Same-Session-Aufnahme: Der eingebettete, fest begrenzte "
                + "A1-Fokus-Hook fokussiert die Bildmitte, während die von lcc "
                + "geöffnete HAL-Preview aktiv bleibt. Nur nach bestätigtem "
                + "Fokusstatus 0 folgt Modul A1 mit 20 ms und Gain 1, genau "
                + "einmal pro App-Installation.\n\n"
        ...
        captureButton.setText("2. A1 CENTER-AF + 20 MS AUSLÖSEN");
    ...
    private void startPreflight() {
        ...
        }, "l16-a1-read-only-preflight").start();
    }
    ...
    private void startCapture() {
        ...
        setOutputText(
            "Der feste Root-Ablauf startet lcc. Innerhalb derselben offenen "
                + "HAL-Sitzung wird Center-AF ausgeführt; nur bei Fokusstatus 0 "
                + "wird anschließend genau A1 mit 20 ms ausgelöst …\n"
        );
        new Thread(new Runnable() {
        ...
        }, "l16-a1-inline-focus-capture-once").start();
    }
    ...
    private static boolean validPassResult(String text) {
        return "L16_HOSTLESS_A1_INLINE_AF_CAPTURE_V1".equals(
